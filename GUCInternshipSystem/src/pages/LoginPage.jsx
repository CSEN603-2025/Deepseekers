    ...
    <div className="login-container">
      <Card className="login-card">
        ...
        <Nav
          ...
          className="custom-tabs mb-4 d-flex justify-content-center"
        >
          <Nav.Item><Nav.Link eventKey="student">Student</Nav.Link></Nav.Item>
          <Nav.Item><Nav.Link eventKey="company">Company</Nav.Link></Nav.Item>
          <Nav.Item><Nav.Link eventKey="admin">SCAD Member</Nav.Link></Nav.Item>
          <Nav.Item><Nav.Link eventKey="faculty">Faculty Academic</Nav.Link></Nav.Item>
        </Nav>
